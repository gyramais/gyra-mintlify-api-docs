...
| `BUSINNES_PARTNERS_RESTRICTIVE` | IS_TRUE | `DENIED` |
| `OWNER_LAWSUITS_HAS_BY_COURT_TYPE` | IS_TRUE | `DENIED` |
...
| `PEFIN_NOT_CALCULATED_REVENUE` | < 10% | `APPROVED` (+100) |
| `SCR_NOT_CALCULATED_REVENUE_EXPIRED` | < 5% | `APPROVED` (+100) |
...
| `LAWSUITS_NOT_CALCULATED_REVENUE` | < 20% | `APPROVED` (+50) |
