...
<AccordionGroup>
  ...
  <Accordion title="Posso conectar múltiplas organizações?">
    Sim, com um login por organização. Para stdio, adicione várias entradas em `mcpServers` com nomes distintos (ex: `gyra-orgA`, `gyra-orgB`), cada uma com o e-mail e a senha daquela organização. Para custom connector, adicione múltiplos connectors no Claude.
  </Accordion>
