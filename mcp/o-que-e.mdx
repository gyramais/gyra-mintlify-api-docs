...
description: "Servidor MCP (Model Context Protocol) que expõe a API da GYRA+ como ferramentas para agentes de IA, permitindo rodar análises, criar webhooks e gerar insights via linguagem natural."
icon: "plug"
---
...
- **Rodar análises**: `create_report`, `re_analyze_report`, `analyze_report`
...
- **Credenciais (BYOC)**: `create_credential`, `get_credential`, `list_credentials`, `update_credential`, `delete_credential`
- **Insights**: `generate_insight`, `review_insight`
