...
| ----- | --------- | --------------- |
| **SIMPLES** | Cadastral, básico | 2 a 5 s |
| **ESSENCIAL** | + Bureau, Protestos, PEFIN/REFIN, Processos, Vínculos 1º nível | 5 a 15 s |
| **COMPLETO** | + SCR (com consentimento), Mídia, Demografia, Benefícios | 10 a 30 s |
| **COMPLETO+** | + Processos desde 1980 e histórico estendido em fontes aplicáveis | 15 a 45 s |
