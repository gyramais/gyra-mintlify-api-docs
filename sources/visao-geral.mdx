...
| **Protestos** | Protestos em cartório (bureau da análise por padrão; Cenprot nacional como fonte adicional) | Restritivo cartorial |
...
| **Contatos e Localização** | Telefones, e-mails, endereços, mapa, fotos de fachada | Validação cadastral, anti-fraude, cobrança |
| **Financeira** | Faturamento/renda presumidos, balanço, indicadores contábeis | Capacidade, limite proporcional ao faturamento |
| **Inteligência de Pagamentos (Núclea)** | Fluxo transacionado, predição, concentração e liquidez (PJ, fonte adicional) | Capacidade por fluxo real, concentração |
...
| Nível | Cobertura | Latência típica |
| ----- | --------- | --------------- |
| **SIMPLES** | Cadastral + Contatos e Localização (mapa e fachada inclusos) | 2 a 5 s |
| **ESSENCIAL** | + Bureau, Vínculos 1º nível, Processos (desde 2014) | 5 a 15 s |
| **COMPLETO** | + PEFIN/REFIN, Bad Check, Protestos, SCR (com consentimento), PEP/Sanções, Criminal, Mídia, Benefícios, Certidões (parciais) | 10 a 30 s |
| **COMPLETO+** | + Processos desde 1980, certidões completas, histórico estendido em fontes aplicáveis | 15 a 45 s |

A janela histórica estendida do **COMPLETO+** (desde 1980) aplica-se especificamente a **processos judiciais**. No COMPLETO, processos cobrem desde 2014.
...
2. **Avaliação**: cada regra da política puxa o campo da fonte relevante (ex: a regra `SCORE` puxa da fonte bureau).
...
<AccordionGroup>
  ...
  <Accordion title="Tem como ver quanto cada fonte custou?">
    A granularidade de custo por fonte/análise é fornecida pela equipe financeira da GYRA+ conforme contrato. Hoje não há tela no toolbox para esse breakdown.
  </Accordion>
