...
| Cache interno | sem cache (cada análise consulta novamente) |

Na prática: uma alteração cadastral registrada hoje na Receita (ex: baixa de CNPJ) aparece na nossa consulta em 1 a 2 dias.
...
- **Defasagem da Receita:** a Receita Federal demora a atualizar certos campos (ex: mudança de regime tributário). Dado pode estar correto mas desatualizado por semanas.
