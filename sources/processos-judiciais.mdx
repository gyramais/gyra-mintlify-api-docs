...
| Janela coberta (COMPLETO+) | histórico desde **1990** |
| Janela coberta (COMPLETO e ESSENCIAL) | desde **2014**, sempre com as últimas movimentações |
...
<AccordionGroup>
  ...
  <Accordion title="Qual nível de relatório inclui processos?">
    Disponível a partir do relatório **ESSENCIAL**, com mais detalhe em **COMPLETO**.
  </Accordion>
</AccordionGroup>
