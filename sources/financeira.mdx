...
No resumo do relatório, aparece o **faturamento presumido** para CNPJ e a **renda presumida** para CPF. Os valores vêm do **Bureau de Crédito Principal**, com fallback para o **Bureau de Crédito Complementar** quando há sobreposição, **ou de outras fontes** (inferência interna, dados cadastrais, declarações públicas) quando o bureau não entrega valor para aquele documento.
...
## Como o balanço chega ao relatório

Por dois caminhos, que se somam:

- **A GYRA+ encontra.** Em relatórios COMPLETO e COMPLETO+, a plataforma busca demonstrações da empresa na base própria de mais de **170 mil balanços**, alimentada pela CVM e por scrapers de publicações legais em diários oficiais e jornais de grande circulação. Achando, processa automaticamente (se a política tem o cartão *Balanço patrimonial* ligado em Fontes de dados) ou sinaliza na aba para você decidir.
- **Você envia.** Upload de PDF no input da análise (junto com o CNPJ) ou pelo menu *Enviar balanço* (3 pontinhos) de um relatório já gerado, com seleção de páginas e vários arquivos por vez.

O passo a passo completo, a mecânica multi-período e a lista de indicadores estão em **[Análise Financeira](/concepts/analise-financeira)**.
...
- **Balanço depende de existir uma fonte**. Se a empresa não publica demonstrações e ninguém envia o PDF, as seções contábeis não aparecem no relatório e fica só o faturamento presumido. A busca automática cobre quem publica (companhia aberta na CVM, S.A. de capital fechado em publicação legal), não a empresa que nunca publicou.
...
<AccordionGroup>
  <Accordion title="Faturamento presumido vem pelo contrato padrão?">
    O campo sai do Bureau de Crédito Principal ou de outras fontes quando nenhum bureau entrega valor para o documento. O nível do relatório contratado e a combinação de bureaus ativos definem qual valor populou o campo.
  </Accordion>
