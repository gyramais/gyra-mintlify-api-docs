...
No resumo do relatório, aparece o **faturamento presumido** para CNPJ e a **renda presumida** para CPF. Os valores vêm dos bureaus (ProScore, Serasa, Boa Vista ou combinação) conforme o nível do relatório contratado. Internamente, os campos principais do bureau são:
...
<AccordionGroup>
  <Accordion title="Faturamento presumido vem pelo contrato padrão?">
    O campo sai dos bureaus contratados (ProScore, Serasa, Boa Vista). O nível do relatório contratado define qual bureau popula o valor.
  </Accordion>
