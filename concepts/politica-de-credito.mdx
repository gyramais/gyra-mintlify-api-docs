...
│       ├── operationType     → Como as regras se combinam (AND, ADD, SUB...)
...
Dentro de um grupo, as regras podem ser combinadas de formas diferentes usando o campo `operationType`:

| Operador | Comportamento |
|----------|---------------|
| `NONE` | Regra avaliada de forma independente |
| `AND` | Todas as regras do grupo devem ser verdadeiras |
| `ADD` | Soma os scores das regras |
| `SUB` | Subtrai o score |
| `DIV` | Divide o score |
| `MULT` | Multiplica o score |
