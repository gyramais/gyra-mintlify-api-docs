...
<Note>
  Duas etapas são obrigatórias: **Fontes de dados**, pelo Relatório base, e **Decisão e alçada**, pelo Objetivo, que o editor exige para salvar. Minhas variáveis, Classificação de risco e Precificação existem para quem precisa delas.
</Note>
...
<Note>
  Uma exceção ao "só o que está ligado é coletado": em relatórios COMPLETO e COMPLETO+, a **busca** por balanços já publicados roda de qualquer forma. O cartão *Balanço patrimonial* controla se o que for encontrado é **processado** automaticamente e se as variáveis de balanço ficam disponíveis nas regras, não se a busca acontece. Ver [Análise Financeira](/concepts/analise-financeira#balan%C3%A7os-que-j%C3%A1-temos).
</Note>
