...
<Note>
**Esta página descreve Operação, um workflow que pode encadear vários relatórios.** Não confundir com Relatório: um [Relatório](/concepts/relatorio) é a análise de uma única entidade; uma Operação pode gerar múltiplos relatórios em cascata (principal + sócios + filiais + endereços + parentes).
</Note>
