...
|------|-----------|---------------|
| **SIMPLES** | Dados cadastrais + localização | Qualificação de leads, higienização de base |
| **ESSENCIAL** | Cadastral + score + relacionamentos + restrições básicas | Crédito de ticket baixo, onboarding rápido |
| **COMPLETO** | Essencial + SCR Bacen + processos desde 2014 | Crédito B2B, análise de risco médio |
| **COMPLETO+** | Completo + certidões em tempo real + processos desde 1980 | Grandes operações, due diligence, risco alto |
