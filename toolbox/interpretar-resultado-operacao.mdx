---
title: "Interpretar Resultado do Relatório"
...
Ao clicar em uma regra, você vê a regra exata avaliada (ex: `SCORE`), a origem do dado (bureau, cadastral, SCR) e o trecho do JSON do relatório que gerou o valor.
