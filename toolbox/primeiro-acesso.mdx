...
```mermaid
flowchart TD
  A["1. Login"] --> B["2. Plataforma chega crua, sem política ativa"]
  B --> C["3. Ativar templates de política"]
  C --> D["4. Credenciais de bureau, opcional"]
  D --> E["5. Escolher política padrão PF e PJ"]
  E --> F["6. Rodar a primeira análise"]
  F --> G["7. Convidar a equipe"]
```
