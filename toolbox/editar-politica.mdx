...
<Steps>
  ...
  <Step title="Fazer as alterações">
    ...
    O menu **Configurar política**, à esquerda, tem as seis etapas. Tudo que pode ser editado:

    - **Fontes de dados**: Relatório base (nível e tipo de documento), bureau de crédito, SCR, e as fontes adicionais **Cenprot** (protestos nacionais, ver [Protestos](/sources/protestos#como-escolher-a-fonte)) e **[Núclea](/sources/inteligencia-pagamentos)** (indicadores de transações reais, PJ), além de **Balanço patrimonial** e **Bases externas**.
    ...
    - **Precificação**: as fórmulas de limite, taxa e prazo. Ver [Precificação](/concepts/precificacao).
