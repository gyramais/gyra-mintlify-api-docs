...
<Steps>
  ...
  <Step title="Fazer as alterações">
    ...
    - **Dados consultados**: ativar ou desativar SCR, janela de processos, níveis de vínculos societários, e **fontes adicionais** (com custo adicional) como **Protestos Cenprot** (cobertura nacional de protestos, ver [Protestos](/sources/protestos#como-escolher-a-fonte)) e os indicadores de **[Inteligência de Pagamentos da Núclea](/sources/inteligencia-pagamentos)** (fluxo transacionado, predição, concentração e liquidez, PJ).
    - **Mensagens**: textos mostrados para `APPROVED`, `ALERT`, `DENIED`.
    - **Comitê de Crédito IA**: se o relatório vai a comitê e como. Ver abaixo.
  </Step>
...
No bloco **Comitê de Crédito IA** você escolhe se o [comitê](/concepts/comite-de-credito) é convocado sozinho ao fim da análise:

- **Não convocar automaticamente**: o comitê só roda pelo botão *Convocar Comitê* dentro do relatório, ou por [`POST /report/{id}/committee`](/api-reference/report/post-reportcommittee). É o modo manual.
...
Com o recurso habilitado, o bloco do comitê exibe um campo de texto por agente (Cadastral, Societário, Financeiro, Comportamental, Jurídico, Macro e Setorial, Compliance e Presidente). É onde você registra as **orientações da sua instituição**: apetite de risco, critérios do setor que você opera e política interna.
