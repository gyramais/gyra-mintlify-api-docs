...
<Note>
  Para CNPJ, você pode **anexar o PDF do balanço** no próprio input, junto com o documento, antes de disparar a análise. O relatório já nasce com a extração financeira em processamento. Também dá para enviar depois, pelo menu *Enviar balanço* do relatório. Detalhes em [Análise Financeira](/concepts/analise-financeira).
</Note>
...
A reanálise existe para casos em que um relatório foi gerado com **dados incompletos ou com erro** em alguma fonte, e ainda **não fechou** com decisão final (`APPROVED` ou `DENIED`).
