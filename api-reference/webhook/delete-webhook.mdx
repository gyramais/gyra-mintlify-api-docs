...
<Note>
  **Exemplo de resposta ainda não verificado contra a API.** Os demais endpoints desta referência tiveram o exemplo capturado de uma chamada real; este não, porque a chamada remove um webhook da organização. Trate o formato abaixo como indicativo e confirme na sua primeira integração.
</Note>
