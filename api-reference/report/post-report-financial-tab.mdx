...
Além dessas, o envio cria `DETAILED_COSTS`, `BALANCE_SHEET_CHART`, `COST_PROFIT_FORECAST`, `SUPPLIERS_CLIENTS`, `FINANCIAL_INSIGHTS` e `FINANCIAL_RECOMMENDATIONS`. A lista completa de tipos está em [Consultar Seção por Tipo](/api-reference/report/get-report-section).
