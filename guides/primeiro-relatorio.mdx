...
<CardGroup cols={2}>
  ...
  <Card title="Enviar balanço e DRE" icon="file-invoice-dollar" href="/api-reference/report/post-report-financial-tab">
    Mande os PDFs das demonstrações e receba balanço, DRE e indicadores estruturados.
  </Card>
</CardGroup>
