...
| `BUSINNES_PARTNERS_RESTRICTIVE` | Sócios com restrições | Negar se algum sócio está negativado |
...
| `PEFIN_NOT_CALCULATED_REVENUE` | Dívidas PEFIN como % do faturamento | Aceitar até 20% do faturamento em dívidas |
...
| `SCR_NOT_CALCULATED_REVENUE_EXPIRED` | Créditos vencidos como % do faturamento | Aceitar até 5% do faturamento vencido |
...
| `LAWSUITS_NOT_CALCULATED_REVENUE` | Processos como % do faturamento | Aceitar até 20% do faturamento em litígios |
| `OWNER_LAWSUITS_HAS_BY_COURT_TYPE` | Sócios com processos criminais | Negar se qualquer sócio tem processo criminal |
